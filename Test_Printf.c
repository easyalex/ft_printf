...
int main()
{
	...
	printf("PRINTF = (Bonjour %10c)\n", 'A');
	printf("----- Test 3 ----- = 'Bonjour %%-7c'\n");
	printf("PRINTF = (Bonjour %-10c)\n", 'A');
	printf("----- Test 4 ----- = 'Bonjour %%--7c' (peut importe le nbr de '-')\n");
	printf("PRINTF = (Bonjour %--10c)\n", 'A');
	printf("----- Test 5 ----- = 'Bonjour %%10.c' == Undifined behavior avec -Werror\n");
	printf("PRINTF = (Bonjour %10.c)\n", 'A');
	printf("----- Test 6 ----- = 'Bonjour %%10.10c' == Undifined behavior avec -Werror\n");
	// printf("PRINTF = (Bonjour %10.10c)\n", 'A');
	printf("----- Test 6 ----- = 'Bonjour %%.10c' == Undifined behavior avec -Werror\n");
	// printf("PRINTF = (Bonjour %.10c)\n", 'A');
	printf("----- Test 6 ----- = 'Bonjour %%.c' == Undifined behavior avec -Werror\n");
	printf("PRINTF = (Bonjour %.c)\n", 'A');
	printf("----- Test 7 ----- = 'Bonjour %%07c' == Undifined behavior avec -Werror\n");
	// printf("PRINTF = (Bonjour %07c)\n", 'A');
	printf("----- Test 8 ----- = 'Bonjour %%@7c' == Undifined behavior avec -Werror\n");
	// printf("PRINTF = (Bonjour %@7$c)\n", 'A');
	printf("----- Test 9 ----- = 'Bonjour %%7#c' == Undifined behavior avec -Werror\n");
	// printf("PRINTF = (Bonjour %7#c)\n", 'A');
