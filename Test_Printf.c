...
int main()
{
	...
	// printf("----- Test 7 ----- = 'Bonjour %%10.10c' == Undifined behavior avec -Werror\n");
	// // printf("PRINTF = (Bonjour %10.10c)\n", 'A');
	// printf("----- Test 8 ----- = 'Bonjour %%.10c' == Undifined behavior avec -Werror\n");
	// // printf("PRINTF = (Bonjour %.10c)\n", 'A');
	// printf("----- Test 9 ----- = 'Bonjour %%.c' == Undifined behavior avec -Werror\n");
	// printf("PRINTF = (Bonjour %.c)\n", 'A');
	// printf("----- Test 10 ----- = 'Bonjour %%07c' == Undifined behavior avec -Werror\n");
	// // printf("PRINTF = (Bonjour %07c)\n", 'A');
	// printf("----- Test 11 ----- = 'Bonjour %%@7c' == Undifined behavior avec -Werror\n");
	...
	// // printf("PRINTF = (Bonjour %07d)\n", 123);
	// printf("----- Test 8 ----- = 'Bonjour [%%-0*d]		== '0' est ignore lorsqu'on met un '-'\n");
